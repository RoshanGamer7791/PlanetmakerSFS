...
atmoheightentry = tk.Entry(atmophysictab, textvariable=atmoheightvar, bg="black", fg="white", font=("Segoe UI", 15, "bold"))
...
atmodensityentry = tk.Entry(atmophysictab, textvariable=atmodensityvar, bg="black", fg="white", font=("Segoe UI", 15, "bold"))
...
atmocurveentry = tk.Entry(atmophysictab, textvariable=atmocurvevar, bg="black", fg="white", font=("Segoe UI", 15, "bold"))
...
atmoparachutemultiplerentry = tk.Entry(atmophysictab, textvariable=atmoparachutemultiplervar, bg="black", fg="white", font=("Segoe UI", 15, "bold"))
...
atmouamultiplierentry = tk.Entry(atmophysictab, textvariable=atmouamultipliervar, bg="black", fg="white", font=("Segoe UI", 15, "bold"))
