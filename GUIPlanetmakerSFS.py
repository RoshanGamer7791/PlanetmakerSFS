...
tk.Label(root, text="SFS Planet Maker by Roshan and ilikespace", font=("Segoe UI", 44, "bold"), background="black", foreground="white").grid(sticky="n")
...
radiusentry = tk.Entry(basedatatab, textvariable=radiusvar, bg="white", fg="black", font=("Segoe UI", 15, "bold"))
...
gravityentry = tk.Entry(basedatatab, textvariable=gravityvar, bg="white", fg="black", font=("Segoe UI", 15, "bold"))
...
timewarpheightentry = tk.Entry(basedatatab, textvariable=timewarpheightvar, bg="white", fg="black", font=("Segoe UI", 15, "bold"))
...
velocityarrowsheightentry = tk.Entry(basedatatab, textvariable=velocityarrowsheightvar, bg="white", fg="black", font=("Segoe UI", 15, "bold"))
...
mapcolorentry = tk.Entry(basedatatab, textvariable=mapcolorvar, bg="white", fg="black", font=("Segoe UI", 15, "bold"))
mapcolorentry.grid(row=4, column=1)

# Atmo Physics Data
atmoheightvar = tk.DoubleVar(value=30000.0)
atmoheightlabel = tk.Label(atmophysictab, text="Height:", bg="black", fg="white", font=("Segoe UI", 15, "bold"))
atmoheightlabel.grid(row=0, column=0)
atmoheightentry = tk.Entry(atmophysictab, textvariable=atmoheightvar, bg="white", fg="black", font=("Segoe UI", 15, "bold"))
atmoheightentry.grid(row=0, column=1)
atmodensityvar = tk.DoubleVar(value=0.005)
atmodensitylabel = tk.Label(atmophysictab, text="Density", bg="black", fg="white", font=("Segoe UI", 15, "bold"))
atmodensitylabel.grid(row=1, column=0)
atmodensityentry = tk.Entry(atmophysictab, textvariable=atmodensityvar, bg="white", fg="black", font=("Segoe UI", 15, "bold"))
atmodensityentry.grid(row=1, column=1)
atmocurvevar = tk.DoubleVar(value=10.0)
atmocurvelabel = tk.Label(atmophysictab, text="Curve:", bg="black", fg="white", font=("Segoe UI", 15, "bold"))
atmocurvelabel.grid(row=2, column=0)
atmocurveentry = tk.Entry(atmophysictab, textvariable=atmocurvevar, bg="white", fg="black", font=("Segoe UI", 15, "bold"))
atmocurveentry.grid(row=2, column=1)
atmoparachutemultiplervar = tk.DoubleVar(value=1.0)
atmoparachutemultiplerlabel = tk.Label(atmophysictab, text="Parachute Multiplier:", bg="black", fg="white", font=("Segoe UI", 15, "bold"))
atmoparachutemultiplerlabel.grid(row=3, column=0)
atmoparachutemultiplerentry = tk.Entry(atmophysictab, textvariable=atmoparachutemultiplervar, bg="white", fg="black", font=("Segoe UI", 15, "bold"))
atmoparachutemultiplerentry.grid(row=3, column=1)
atmouamultipliervar = tk.DoubleVar(value=0.333)
atmouamultiplierlabel = tk.Label(atmophysictab, text="Upper Atmosphere Multiplier:", bg="black", fg="white", font=("Segoe UI", 15, "bold"))
atmouamultiplierlabel.grid(row=4, column=0)
atmouamultiplierentry = tk.Entry(atmophysictab, textvariable=atmouamultipliervar, bg="white", fg="black", font=("Segoe UI", 15, "bold"))
atmouamultiplierentry.grid(row=4, column=1)
sivar = tk.DoubleVar(value=1.0)
silabel = tk.Label(atmophysictab, text="Shockwave Intensity:", bg="black", fg="white", font=("Segoe UI", 15, "bold"))
silabel.grid(row=5, column=0)
sientry = tk.Entry(atmophysictab, textvariable=sivar, bg="white", fg="black", font=("Segoe UI", 15, "bold"))
sientry.grid(row=5, column=1)
mhvmvar = tk.DoubleVar(value=1.0)
mhvmlabel = tk.Label(atmophysictab, text="Minimum Heating Velocity Multiplier:", bg="black", fg="white", font=("Segoe UI", 15, "bold"))
mhvmlabel.grid(row=6, column=0)
mhvmentry = tk.Entry(atmophysictab, textvariable=mhvmvar, bg="white", fg="black", font=("Segoe UI", 15, "bold"))
mhvmentry.grid(row=6, column=1)
...
tabs.columnconfigure(0, weight=3)
tabs.rowconfigure(0, weight=3)
...
def generate_config():
    ...
    actual_atmo = atmoheightvar.get()
    density = atmodensityvar.get()
    curve = atmocurvevar.get()
    parachuteMultiplier = atmoparachutemultiplervar.get()
    upperAtmosphere = atmouamultipliervar.get()
    shockwaveIntensity = sivar.get()
    minHeatingVelocityMultiplier = mhvmvar.get()
    print("")
